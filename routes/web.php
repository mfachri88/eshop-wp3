...
//API Google - Menggunakan URL yang tepat sesuai .env
...
Route::middleware('is.customer')->group(function () {
    ...
    // Route untuk mengupdate kuantitas item di keranjang
    ...
    Route::get('select-payment', [OrderController::class, 'selectPayment'])->name('order.select-payment');
